              ...
              children: [
                const AnalyticsDashboardStrip(
                  kpiCards: [
                    ...
                    KpiCardId.subscriptionsCanceledCount,
                    KpiCardId.subscriptionsExpiredCount,
                  ],
                  chartCards: [
                    ChartCardId.subscriptionsActiveOverTime,
                    ChartCardId.subscriptionsStatusDistribution,
                    ChartCardId.subscriptionsByStoreProvider,
                  ],
                ),
                if (state.status == SubscriptionsStatus.loading &&
