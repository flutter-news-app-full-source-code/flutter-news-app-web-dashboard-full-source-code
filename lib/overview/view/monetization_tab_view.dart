...
import 'package:flutter_news_app_web_dashboard/shared/widgets/analytics/chart_card.dart';
...
class _MonetizationTabViewState extends State<MonetizationTabView>
  ...
  void initState() {
    ...
    context.read<OverviewBloc>().add(
      const AnalyticsDataRequested(tab: OverviewTab.monetization),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<OverviewBloc, OverviewState, TabAnalyticsState?>(
      selector: (state) => state.tabStates[OverviewTab.monetization],
