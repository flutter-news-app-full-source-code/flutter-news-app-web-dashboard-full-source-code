...
import 'package:flutter_news_app_web_dashboard_full_source_code/overview/bloc/overview_page_bloc.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<OverviewPageBloc, OverviewPageState>(
          builder: (context, state) {
            switch (state.status) {
              case OverviewPageStatus.initial:
              ...
              case OverviewPageStatus.failure:
                return FailureStateWidget(
                  exception: UnknownException(state.error.toString()),
                  onRetry: () => context.read<OverviewPageBloc>().add(
                ...
                return SingleChildScrollView(
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      const kpiCards = OverviewPageBloc.kpiCards;
                      const chartCards = OverviewPageBloc.chartCards;
                      const rankedListCards = OverviewPageBloc.rankedListCards;
