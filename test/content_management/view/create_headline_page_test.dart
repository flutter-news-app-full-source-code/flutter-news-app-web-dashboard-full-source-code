...
import 'package:flutter_news_app_web_dashboard/content_management/bloc/create_headline/create_headline_bloc.dart';
...
import 'package:flutter_news_app_web_dashboard/shared/widgets/image_upload_field.dart';
import 'package:flutter_news_app_web_dashboard/shared/widgets/searchable_selection_input.dart';
  ...
  group('CreateHeadlinePage', () {
    ...
    group('form interactions', () {
      ...
      testWidgets(
        ...
        (tester) async {
          const initialState = CreateHeadlineState(
            enabledLanguages: [SupportedLanguage.en, SupportedLanguage.es],
          );
          const stateAfterTabChange = CreateHeadlineState(
            enabledLanguages: [SupportedLanguage.en, SupportedLanguage.es],
      ...
      testWidgets('adds CreateHeadlineSourceChanged when source is selected', (
        ...
        await tester.pumpApp(buildSubject(), goRouter: goRouter);
        final sourceInputFinder = find.byType(SearchableSelectionInput<Source>);
        await tester.ensureVisible(sourceInputFinder);
        await tester.tap(sourceInputFinder);
        await tester.pumpAndSettle();
